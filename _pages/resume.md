...
## Introduce
영상 처리와 BLE 통신 기반 Android 개발을 수행하고 있습니다.
BodyCam 프로젝트를 중심으로 실시간 녹화, 인코딩, 디바이스 연동 기능을 설계/구현했습니다.

## Experience
### Cybertel | Android Developer
**2024.07 ~ Present**
- 경찰청 BodyCam 앱 개발
- Vodafone GC App 신규 기능 개발 및 최적화
- MCLoc 앱 개발

## Projects
### BodyCam
- Camera2 기반 녹화 파이프라인 구현
- H.264/H.265 인코딩 및 MediaMuxer 기반 저장 처리
